...
```
##### 2 low-magic
The only &#x2728; magical &#x2728; code in zunit is how it automatically exports suites without using `module.exports` by inspecting the call stack. If you prefer you can [create test suites by hand](#creatingsuitesandtestsbyhand).
